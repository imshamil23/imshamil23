...
role:         Automation Analyst (promoted from Data Analyst)
company:      AM Motors — 25+ branch Maruti Suzuki dealership
location:     Kerala, India
focus:        Excel/VBA automation → Power BI dashboards → SQL (leveling up)
currently:    Cutting reporting time, one broken workflow at a time
...
<br/>
<img src="https://img.shields.io/badge/VBA-8B5CF6?style=flat-square&logo=visualstudiocode&logoColor=white"/>
...
<div align="center">
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/imshamil23/imshamil23/output/github-contribution-grid-snake-dark.svg">
  <img alt="github contribution snake" src="https://raw.githubusercontent.com/imshamil23/imshamil23/output/github-contribution-grid-snake.svg">
</picture>
</div>

> ℹ️ This snake animates automatically once the included GitHub Action (`snake.yml`) runs on your `imshamil23/imshamil23` repo — see setup notes below.
